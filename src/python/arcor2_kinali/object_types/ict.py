...
class Ict(AbstractWithPose):
    ...
    def test(self, serial_number: str) -> bool:
        ...
        return rest.call(rest.Method.GET, f"{self.settings.url}/tester/test", params={"serialNumber": serial_number}, return_type=bool)

    def ready(self) -> bool:
        """Determines whether the ICT Tester is open and ready to start testing.
