...
def _scene_service():
    try:
        ...
        raise Arcor2Exception("Scene service client arcor2_scene_data is not installed.") from exc
...
class CollisionObject(GenericWithPose):
    ...
    def __init__(
        ...
        _scene_service().upsert_collision(self.collision_model, pose)
    ...
    def enabled(self, enabled: bool) -> None:
        if not self._enabled and enabled:
            ...
            svc.upsert_collision(self.collision_model, self.pose)
