...
from arcor2_object_types.parameter_plugins.base import ParameterPlugin
...
def load_plugins() -> None:
    ...
    from arcor2_object_types.parameter_plugins.double import DoublePlugin
    from arcor2_object_types.parameter_plugins.image import ImagePlugin
    from arcor2_object_types.parameter_plugins.integer import IntegerPlugin
    from arcor2_object_types.parameter_plugins.integer_enum import IntegerEnumPlugin
    from arcor2_object_types.parameter_plugins.joints import JointsPlugin
    ...
    from arcor2_object_types.parameter_plugins.string import StringPlugin
    from arcor2_object_types.parameter_plugins.string_enum import StringEnumPlugin
