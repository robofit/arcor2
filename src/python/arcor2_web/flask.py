    ...
    *,
    ...
    if dataclasses is not None:
        for dc in dataclasses:
            dc_name = dc.__name__
            if dc_name in spec.components.schemas:
                # dataclasses_jsonschema registers referenced dataclasses, avoid duplicate component names
                continue
            spec.components.schema(dc_name, schema=dc)
